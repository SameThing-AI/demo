  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newAssessment = {
        ...
        duration: finalAssessmentType === 'traditional' ? 60 : 90, // AI assessments get more time
      ...
      onAssessmentGenerated({ 
        ...newAssessment, 
        timeLimit: newAssessment.duration,
