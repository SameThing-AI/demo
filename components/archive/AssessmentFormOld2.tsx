...
export default function AssessmentForm({ onAssessmentGenerated, onBack }: AssessmentFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('📝 Questions generated:', assessmentData.questions?.length || 0)
      console.log('🎯 AI-generated features:', assessmentData.uniqueFeatures?.length || 0)
      
      // Ensure we have questions for the assessment
      if (!assessmentData.questions || assessmentData.questions.length === 0) {
        throw new Error('No questions generated for assessment')
      }
